...
##### TESTING #####
# Example Usage with state teacher salary data
import geopandas as gpd
df = gpd.read_file("https://raw.githubusercontent.com/nathanjones4323/helpful-python-functions/main/functions/folium/choropleth/county_df.json")
